...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initGalaChat() {
    ...
    wrapper.innerHTML = '<button class="gala-launcher" type="button" aria-expanded="false" aria-controls="galaPanel"><span class="gala-launcher-avatar"><img src="/assets/images/chatbot%20logo.jpg" alt=""><span class="gala-launcher-label">GALA</span></span><span class="gala-launcher-prompt">Ask GALA</span></button>' +
      '<div class="gala-panel" id="galaPanel" hidden><div class="gala-panel-header"><div class="gala-brand"><span class="gala-brand-mark"><img src="/assets/images/chatbot%20logo.jpg" alt=""></span><span><strong>GALA</strong><small>Garcia Legal Assistant</small></span></div><button class="gala-close" type="button" aria-label="Close GALA">&times;</button></div>' +
