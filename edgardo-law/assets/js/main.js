...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initGalaChat() {
    ...
    wrapper.innerHTML = '<button class="gala-launcher" type="button" aria-label="Open GALA" aria-expanded="false" aria-controls="galaPanel"><span class="gala-launcher-avatar"><img src="/assets/images/chatbot%20logo.jpg" alt=""><span class="gala-launcher-label">GALA</span></span></button>' +
