import { T as e, d as t, g as n, v as ee, w as r } from "./_react-D4KM8XEu.js";
import { S as i } from "./chunk-KS7C4IRE-Ck3O4oo2.js";
import { o as a } from "./users-inweyKL5.js";
import { i as o, r as s } from "./use-navigate-with-base-path-DsJTGDSS.js";
import { X as c, Y as l, a as u, d, g as f, m as p } from "./use-activity-pub-queries-CX9snsLs.js";
import { B as m, H as h, L as g, N as _, Q as te, R as v, U as y, V as b, W as x, X as S, a as C, nt as w, rt as T, tt as E, ut as D, z as O } from "./routes-DdyY9uFF.js";
import { c as k, p as A } from "./content-formatters-CLcjaBwV.js";
import { t as j } from "./copy-DcOh8kXw.js";
import { t as M } from "./edit-profile-BqMLQV88.js";
import "./layout-BL4_jtuV.js";
//#region src/views/preferences/components/bluesky-sharing.tsx
t();
var N = i(), ne = 5e3, P = 12, F = () => {
	let { data: t, isLoading: i } = u("index", "me"), [F, I] = e(() => t?.blueskyEnabled && !t?.blueskyHandleConfirmed), [L, R] = e(!1), [z, B] = e(!1), [V, H] = e(!1), [U, W] = e(!1), G = r(0), K = f("index"), q = p("index"), J = d("index"), Y = async () => {
		...
		if (!t?.avatarUrl) B(!0);
			...
			try {
				...
				I(!1), a.error("Something went wrong, please try again.");
			}
		}
	}, Z = async () => {
		I(!0);
		try {
			await q.mutateAsync(), H(!1), a.success("Bluesky sharing disabled");
		} finally {
			I(!1);
		}
	}, Q = n(() => {
	...
	if (ee(() => {
		...
		if (t?.blueskyHandleConfirmed) {
			W(!0), I(!1), G.current > 0 && a.success("Bluesky sharing enabled"), G.current = 0;
			return;
		}
		W(!1), I(!0), G.current = 0;
		let e = setInterval(async () => {
			if (G.current += 1, G.current > P) {
				clearInterval(e), a.error("Something went wrong, please try again."), await q.mutateAsync(), I(!1);
				return;
			}
			Q();
		}, ne);
		...
		Q
	]), i) return /* @__PURE__ */ (0, N.jsx)(C, { children: /* @__PURE__ */ (0, N.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, N.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, N.jsx)(_, { size: "md" })
		})]
	}) });
	let $ = t?.blueskyEnabled && t?.blueskyHandleConfirmed;
	return /* @__PURE__ */ (0, N.jsxs)(C, { children: [/* @__PURE__ */ (0, N.jsxs)("div", {
		className: "mx-auto max-w-[620px] py-[min(4vh,48px)]",
			...
			children: [
				...
				t?.avatarUrl ? /* @__PURE__ */ (0, N.jsxs)(N.Fragment, { children: [/* @__PURE__ */ (0, N.jsx)(s, {
					...
					children: F ? /* @__PURE__ */ (0, N.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, N.jsx)(_, { size: "sm" }), /* @__PURE__ */ (0, N.jsx)("span", { children: "Enabling Bluesky sharing..." })]
					...
					open: z,
					onOpenChange: B,
					children: [/* @__PURE__ */ (0, N.jsx)(T, { children: /* @__PURE__ */ (0, N.jsx)(s, {
						className: "h-10 w-full text-base",
						variant: "secondary",
						children: "Edit profile"
					}) }), /* @__PURE__ */ (0, N.jsxs)(te, {
						className: "w-full max-w-[520px]",
						onOpenAutoFocus: (e) => e.preventDefault(),
						children: [/* @__PURE__ */ (0, N.jsx)(E, { children: /* @__PURE__ */ (0, N.jsx)(w, { children: "Profile settings" }) }), t && /* @__PURE__ */ (0, N.jsx)(M, {
							account: t,
		...
		open: V,
		onOpenChange: H,
		children: /* @__PURE__ */ (0, N.jsxs)(m, { children: [/* @__PURE__ */ (0, N.jsxs)(y, { children: [/* @__PURE__ */ (0, N.jsx)(x, { children: "Disable Bluesky sharing?" }), /* @__PURE__ */ (0, N.jsx)(b, { children: "Your bridged Bluesky account will be deactivated and your content will no longer be shared on Bluesky. You can re-enable sharing at any time." })] }), /* @__PURE__ */ (0, N.jsxs)(h, { children: [/* @__PURE__ */ (0, N.jsx)(O, { children: "Cancel" }), /* @__PURE__ */ (0, N.jsx)(v, {
			className: o({ variant: "destructive" }),
			disabled: F,
			onClick: (e) => {
				e.preventDefault(), Z();
			},
			children: F ? /* @__PURE__ */ (0, N.jsx)(_, {
				color: "light",
				size: "sm"
			}) : "Disable"
		})] })] })
...
//# sourceMappingURL=bluesky-sharing-C7nTDMvw.js.map