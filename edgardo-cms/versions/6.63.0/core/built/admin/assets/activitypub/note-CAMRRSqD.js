...
import { S as a, d as o } from "./chunk-KS7C4IRE-Ck3O4oo2.js";
import { t as s, w as c } from "./use-navigate-with-base-path-DsJTGDSS.js";
import { K as l } from "./use-activity-pub-queries-CX9snsLs.js";
import { C as u, E as d, N as f, S as p, a as m, g as h, i as g, r as _ } from "./routes-DdyY9uFF.js";
import { c as v, l as y, u as b } from "./content-formatters-CLcjaBwV.js";
import { t as x } from "./hash-C7u-irQQ.js";
import { i as S, n as C, r as w, t as T } from "./use-reply-chain-data-AJi9zkzm.js";
//#region src/views/feed/note.tsx
n();
var E = a(), D = () => /* @__PURE__ */ (0, E.jsx)("div", { className: "h-px w-full bg-gray-200 dark:bg-gray-950" }), O = () => {
	let { postId: n } = o(), { canGoBack: a } = c(), [O, k] = e(/* @__PURE__ */ new Set()), [A, j] = e(/* @__PURE__ */ new Set()), [M, N] = e(/* @__PURE__ */ new Set()), [P, F] = e(!1), I = i(null), L = i(null), R = i(null), z = i(null), B = s(), { threadParents: V, post: H, processedReplies: U, isLoading: W, loadMoreChildren: G, loadMoreChildReplies: K, hasMoreChildren: q, hasMoreChildReplies: J } = T(decodeURIComponent(n ?? ""), { includeAncestors: !0 }), Y = H?.object, X = Y?.replyCount ?? 0, [Z, Q] = e(!1);
	if (r(() => {
...
//# sourceMappingURL=note-CAMRRSqD.js.map