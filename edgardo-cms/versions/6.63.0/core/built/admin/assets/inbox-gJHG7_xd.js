...
</style>`,Te=t({default:()=>Ee}),Ee=`(function () {
...
`,G=t({default:()=>Ne}),Ne=`.kg-audio-card,
.kg-audio-card * {
  box-sizing: border-box;
}
...
`,Pe=t({default:()=>Fe}),Fe=`.kg-blockquote-alt {
  font-size: 1.5em;
  font-style: italic;
  line-height: 1.7em;
  text-align: center;
...
`,Ie=t({default:()=>K}),K=`.kg-bookmark-card,
.kg-bookmark-card * {
  box-sizing: border-box;
}
...
`,Le=t({default:()=>Re}),Re=`.kg-button-card,
.kg-button-card * {
  box-sizing: border-box;
}
...
`,q=t({default:()=>ze}),ze=`.kg-callout-card,
.kg-callout-card * {
  box-sizing: border-box;
}
...
`,J=t({default:()=>Y}),Y=`.kg-collection-card {
  width: 100%;
  margin-top: 6vmin;
}
...
`,Be=t({default:()=>Ve}),Ve=`.kg-cta-card,
.kg-cta-card * {
  box-sizing: border-box;
}
...
`,Ue=t({default:()=>We}),We=`.kg-gallery-card,
.kg-gallery-card * {
  box-sizing: border-box;
}
...
`,Ge=t({default:()=>Z}),Z=`.kg-header-card,
.kg-header-card * {
  box-sizing: border-box;
}
...
`,Ke=t({default:()=>qe}),qe=`.kg-header-card.kg-v2 {
  position: relative;
  padding: 0;
  min-height: initial;
  text-align: initial;
...
`,Je=t({default:()=>Ye}),Ye=`.kg-nft-card,
.kg-nft-card * {
  box-sizing: border-box;
}
...
`,Xe=t({default:()=>Ze}),Ze=`.kg-product-card,
.kg-product-card * {
  box-sizing: border-box;
}
...
`,Qe=t({default:()=>$e}),$e=`.kg-signup-card {
  position: relative;
}
...
`,et=t({default:()=>tt}),tt=`.kg-toggle-card,
.kg-toggle-card * {
  box-sizing: border-box;
}
...
`,nt=t({default:()=>rt}),rt=`.kg-transistor-card {
  display: flex;
  justify-content: center;
}
...
`,it=t({default:()=>at}),at=`.kg-video-card,
.kg-video-card * {
  box-sizing: border-box;
}
...
`),Q=`gh-sensitive-media-hidden`,ut=`audio, canvas, embed, iframe, img, object, picture, source, svg, video`,dt=({postUrl:e,heading:t,image:n,excerpt:r,authors:i,html:a,hideMedia:o=!1,backgroundColor:s,fontSize:c,fontStyle:l,onHeadingsExtracted:u,onIframeLoad:f,onLoadingChange:p,isPopoverOpen:m})=>{let h=(0,R.useRef)(null),[_,v]=(0,R.useState)(!0),[ee,b]=(0,R.useState)(`0px`),x=(0,R.useRef)(null),S=document.documentElement.classList.contains(`dark`)&&s===`SYSTEM`||s===`DARK`,C=we(),w=typeof window<`u`&&typeof window.matchMedia==`function`&&window.matchMedia(`(hover: none) and (pointer: coarse)`).matches,T=(0,R.useMemo)(()=>ne(te(w?g(a):a)),[a,w]),E=(0,R.useCallback)(()=>{let e=h.current,t=e?.contentDocument;if(!t)return;t.documentElement.classList.toggle(Q,o);let n=e.contentWindow;n&&typeof n.resizeIframe==`function`&&n.resizeIframe()},[o]),D=`
        <html class="${o?`${Q} `:``}has-${S?`light`:`dark`}-text has-${l}-body ${s===`SEPIA`&&`has-sepia-bg`}">
        <head>
            ${C}
            <style>
                :root {
        ...
        <body>
            <header class='gh-article-header gh-canvas'>
                <h1 class='gh-article-title is-title' data-test-article-heading>${O(t)}</h1>
                ${r?`<p class='gh-article-excerpt'>${O(r)}</p>`:``}
                <a href="${e&&y(e)?O(e):`#`}" target="_blank" rel="noopener noreferrer" class="gh-article-meta">
                    ${i&&i.length>0?`
                        <div class="gh-article-author-image">
                        ${i.map(e=>`
                                <span>
                                    ${e.profile_image?`<img src="${O(e.profile_image)}" alt="${O(e.name)}">`:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24" width="24"><path d="M6.75 6a5.25 5.25 0 1 0 10.5 0 5.25 5.25 0 1 0 -10.5 0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M2.25 23.25a9.75 9.75 0 0 1 19.5 0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></svg>`}
                                </span>
                            `).join(``)}
                        </div>
                    `:``}
                    <div class="gh-article-meta-wrapper">
                        ${i&&i.length>0?`
                            <span class="gh-article-author-name">
                                ${i.length>1?`${O(i[0].name)} and ${i.length-1} ${i.length-1==1?`other`:`others`}`:O(i[0].name)}
                            </span>
                        `:``}
                        <span class="gh-article-source">${e&&y(e)?O(new URL(e).hostname):``} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link-icon lucide-external-link"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg></span>
                    </div>
                </a>
                ${n?`
    ...
    `;return(0,R.useEffect)(()=>{let a=h.current;if(!a)return;let o=e=>{if(e.data.type===`resize`){let t=`${e.data.bodyHeight+24}px`;b(t),a.style.height=t,e.data.isLoaded&&(E(),v(!1))}},s=e=>{if(e.key===`Escape`){e.preventDefault(),e.stopPropagation();let t=new KeyboardEvent(`keydown`,{key:`Escape`,code:`Escape`,keyCode:27,which:27,bubbles:!0,cancelable:!0});document.dispatchEvent(t)}},c=()=>{let e=a.contentWindow;e&&e.addEventListener(`keydown`,s),E()};a.addEventListener(`load`,c),window.addEventListener(`message`,o);let l=[T,t,r??``,n??``,e??``,(i??[]).map(e=>`${e.name}\0${e.profile_image}`).join(`
`)].join(`
`);return x.current!==l&&(x.current=l,v(!0),a.srcdoc=D),()=>{window.removeEventListener(`message`,o),a.removeEventListener(`load`,c);let e=a.contentWindow;e&&e.removeEventListener(`keydown`,s)}},[T,i,r,t,D,n,e,E]),(0,R.useEffect)(()=>{E()},[E]),(0,R.useEffect)(()=>{let e=h.current;if(!e)return;let t=e.contentDocument||e.contentWindow?.document;if(!t)return;let n=t.documentElement;n.style.setProperty(`--font-size`,c),n.classList.remove(`has-sans-body`,`has-serif-body`),n.classList.add(`has-${l}-body`),n.classList.remove(`has-dark-text`,`has-light-text`),n.classList.add(`has-${S?`light`:`dark`}-text`),s===`SEPIA`?n.classList.add(`has-sepia-bg`):n.classList.remove(`has-sepia-bg`);let r=e.contentWindow;if(r&&typeof r.resizeIframe==`function`)r.resizeIframe();else{let e=new Event(`resize`);t.dispatchEvent(e)}},[c,l,s,S]),(0,R.useEffect)(()=>{let e=h.current;if(!e)return;let t=()=>{if(!e.contentDocument)return;let t=Array.from(e.contentDocument.querySelectorAll(`.gh-content > :is(h2, h3, h4, h5, h6)[id]`));if(t.length===0)return;let n=Math.min(...t.map(e=>parseInt(e.tagName[1]))),r=t.map((e,t)=>{let r=`heading-${t}`;e.id=r;let i=parseInt(e.tagName[1])-n+1;return{id:r,text:e.textContent||``,level:i,element:e}});u?.(r),f?.(e)};return e.addEventListener(`load`,t),()=>e.removeEventListener(`load`,t)},[u,f]),(0,R.useEffect)(()=>{p?.(_)},[_,p]),(0,z.jsx)(`div`,{className:`w-full pb-6`,children:(0,z.jsxs)(`div`,{className:`relative -mx-6`,children:[_&&(0,z.jsxs)(`div`,{className:`mx-auto mt-6 w-full max-w-[640px] max-lg:px-4`,children:[(0,z.jsxs)(`div`,{className:`mb-6 flex flex-col gap-2`,children:[(0,z.jsx)(d,{className:`h-8`}),(0,z.jsx)(d,{className:`h-8 w-full max-w-md`})]}),(0,z.jsx)(d,{className:`mt-2 h-4`,count:4,randomize:!0}),(0,z.jsx)(d,{className:`mt-8 h-[400px]`}),(0,z.jsx)(d,{className:`mt-2 h-4`,containerClassName:`block mt-7 mb-4`,count:8,randomize:!0})]}),(0,z.jsx)(`iframe`,{ref:h,id:`gh-ap-article-iframe`,style:{width:`100%`,border:`none`,height:ee,overflow:`hidden`,opacity:+!_,transition:`opacity 0.2s ease-in-out`,pointerEvents:m?`none`:`auto`},title:`Embedded Content`})]})})},ft=()=>(0,z.jsx)(`div`,{className:`h-px bg-black/[8%] dark:bg-gray-950`});function pt(e){return new DOMParser().parseFromString(e,`text/html`).querySelector(ut)!==null}var $=new Map,mt=({postId:e=null,onClose:t})=>{let{backgroundColor:n,currentFontSizeIndex:r,fontStyle:i,fontSize:a,handleColorChange:o,setFontStyle:s,increaseFontSize:c,decreaseFontSize:l,resetFontSize:u}=ye(),f=(0,R.useRef)(null),[m,g]=(0,R.useState)(!1),[_,y]=(0,R.useState)(!1),[D,te]=(0,R.useState)(new Set),[O,ne]=(0,R.useState)(new Set),[ie,ae]=(0,R.useState)(new Set),[k,se]=(0,R.useState)(!1),A=(0,R.useRef)(null),j=(0,R.useRef)(null),{post:M,processedReplies:ce,isLoading:F,loadMoreChildren:fe,loadMoreChildReplies:pe,hasMoreChildren:I,hasMoreChildReplies:L}=ve(e??``,{includeAncestors:!1}),B=M,V=B?.object,U=B?.actor,Se=B?.object?.metadata?.ghostAuthors,Ce=V?.replyCount??0,W=V?.content??``,we=typeof V?.image==`string`?V.image:V?.image?.url,Te=(0,R.useMemo)(()=>pt(W),[W]),{contentWarning:Ee,shouldHideContentWarning:De,shouldHideSensitiveMedia:Oe,canHideSensitiveMedia:ke,revealSensitiveMedia:Ae,hideSensitiveMedia:je,revealContentWarning:Me}=T({contentWarning:V?.contentWarning,sensitive:V?.sensitive,hasMedia:!!we||(V?C(V)!==null:!1)||Te,resetKey:e??void 0});(0,R.useEffect)(()=>{if(!I)return;A.current&&A.current.disconnect();let e=f.current;if(e)return A.current=new IntersectionObserver(async e=>{if(e[0].isIntersecting&&I&&!k){se(!0);try{await fe()}catch(e){console.error(`Failed to load more top-level replies:`,e)}finally{se(!1)}}},{root:e,rootMargin:`200px`}),j.current&&A.current.observe(j.current),()=>{A.current&&A.current.disconnect()}},[I,k,fe]);function G(){}function Ne(e){te(t=>{let n=new Set(t);return n.has(e)?n.delete(e):(n.add(e),ne(t=>{let n=new Set(t);return n.add(e),n})),n})}async function Pe(e,t){if(!ie.has(e)){ae(t=>new Set(t).add(e));try{pe&&await pe(t)}catch(e){console.error(`Failed to load more replies for chain:`,e)}finally{ae(t=>{let n=new Set(t);return n.delete(e),n})}}}let Fe=()=>{},Ie=(0,R.useRef)(null),K=`640px`,[Le,Re]=(0,R.useState)(0),[q,ze]=(0,R.useState)(!0),[J]=oe(Re,100);(0,R.useEffect)(()=>{let e=f.current,t=document.getElementById(`object-content`),n=()=>{if(q||!e||!t)return;let n=t.getBoundingClientRect(),r=e.getBoundingClientRect();if(n.height<=r.height){J(100);return}let i=Math.max(0,r.top-n.top),a=t.offsetHeight-e.offsetHeight,o=Math.min(Math.max(i/a*100,0),100),s=Math.round(o/1)*1;J(s)};if(q)return;let r=new MutationObserver(n);return t&&r.observe(t,{childList:!0,subtree:!0,characterData:!0}),e?.addEventListener(`scroll`,n),n(),()=>{e?.removeEventListener(`scroll`,n),r.disconnect()}},[q,J]);let[Y,Be]=(0,R.useState)([]),[Ve,He]=(0,R.useState)(null),[X,Ue]=(0,R.useState)(null),We=(0,R.useCallback)(e=>{Be(e)},[]),Ge=(0,R.useCallback)(e=>{Ue(e)},[]);(0,R.useEffect)(()=>{if(!X?.contentDocument||!Y.length)return;let e=setTimeout(()=>{let e=f.current;if(!e)return;let t=()=>{let t=X.contentDocument;if(!t||!t.documentElement)return;let n=e.scrollTop,r=Y.map(e=>t.getElementById(e.id)).filter(e=>e!==null).map(e=>({element:e,id:e.id,top:e.offsetTop}));if(!r.length)return;let i=null;for(let e of r)if(e.top-100<=n)i=e;else break;He(i?.id||null)};return e.addEventListener(`scroll`,t),t(),()=>{e.removeEventListener(`scroll`,t)}},100);return()=>clearTimeout(e)},[X,Y,Ve]);let Z=p();return(0,R.useEffect)(()=>{let t=f.current;return()=>{t&&e&&$.set(e,t.scrollTop)}},[e]),(0,R.useEffect)(()=>{if(!q&&!F&&e&&f.current){let t=$.get(e);t!==void 0&&t>0&&setTimeout(()=>{f.current&&(f.current.scrollTop=t)},100)}},[q,F,e]),F?(0,z.jsx)(`div`,{className:`max-h-full overflow-auto rounded-md ${n===`DARK`&&`dark`} ${(n===`LIGHT`||n===`SEPIA`)&&`light`} ${H[n].background}`,children:(0,z.jsx)(`div`,{className:`flex h-full flex-col`,children:(0,z.jsxs)(`div`,{className:`relative flex-1`,children:[(0,z.jsx)(`div`,{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${H[n].background} ${H[n].border}`,children:(0,z.jsxs)(`div`,{className:`grid w-full px-8 max-lg:px-4`,style:{gridTemplateColumns:`1fr minmax(0,${K}) 1fr`},children:[(0,z.jsx)(`div`,{className:`flex items-center`,children:(0,z.jsx)(S,{className:H[n].button,onClick:t})}),(0,z.jsxs)(`div`,{className:`col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden`,children:[(0,z.jsx)(d,{className:`size-10 rounded-full`}),(0,z.jsxs)(`div`,{className:`grow pt-1`,children:[(0,z.jsx)(d,{className:`w-full`}),(0,z.jsx)(d,{className:`w-2/3`})]})]}),(0,z.jsx)(`div`,{className:`col-[3/4] flex items-center justify-end gap-2`,children:(0,z.jsx)(be,{backgroundColor:n,currentFontSizeIndex:r,fontStyle:i,onColorChange:o,onDecreaseFontSize:l,onFontStyleChange:s,onIncreaseFontSize:c,onOpenChange:g,onResetFontSize:u})})]})}),(0,z.jsx)(`div`,{className:`relative flex-1 max-lg:px-4`,children:(0,z.jsxs)(`div`,{className:`mx-auto mt-11 w-full max-w-[640px]`,children:[(0,z.jsxs)(`div`,{className:`mb-6 flex flex-col gap-2`,children:[(0,z.jsx)(d,{className:`h-8`}),(0,z.jsx)(d,{className:`h-8 w-full max-w-md`})]}),(0,z.jsx)(d,{className:`mt-2 h-4`,count:4,randomize:!0}),(0,z.jsx)(d,{className:`mt-8 h-[400px]`}),(0,z.jsx)(d,{className:`mt-2 h-4`,containerClassName:`block mt-7 mb-4`,count:8,randomize:!0})]})})]})})}):M?(0,z.jsx)(`div`,{ref:f,className:`max-h-full overflow-auto rounded-md ${n===`DARK`&&`dark`} ${(n===`LIGHT`||n===`SEPIA`)&&`light`} ${H[n].background}`,"data-scrollable-container":!0,children:(0,z.jsx)(z.Fragment,{children:(0,z.jsxs)(`div`,{className:`flex h-full flex-col`,children:[(0,z.jsxs)(`div`,{className:`relative flex-1`,children:[(0,z.jsx)(`div`,{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${H[n].background} ${H[n].border}`,children:(0,z.jsxs)(`div`,{className:`grid w-full px-8 max-lg:px-4`,style:{gridTemplateColumns:`1fr minmax(0,${K}) 1fr`},children:[(0,z.jsx)(`div`,{className:`flex items-center`,children:(0,z.jsx)(S,{className:H[n].button,onClick:t})}),(0,z.jsxs)(`div`,{className:`col-[2/3] mx-auto flex w-full items-center justify-between gap-3 max-md:hidden`,children:[(0,z.jsx)(me,{actor:U,isCurrentUser:V.authored,children:(0,z.jsxs)(`div`,{className:`flex cursor-pointer items-center gap-3`,children:[(0,z.jsx)(`div`,{className:`relative z-10 pt-0.5`,children:(0,z.jsx)(re,{author:U})}),(0,z.jsxs)(`div`,{className:`relative z-10 mt-0.5 flex min-w-0 cursor-pointer flex-col overflow-visible text-[1.5rem]`,onClick:e=>ee(U,Z,e),children:[(0,z.jsx)(`div`,{className:`flex w-full`,children:(0,z.jsx)(`span`,{className:`min-w-0 truncate font-semibold whitespace-nowrap text-black hover:underline dark:text-white`,children:F?(0,z.jsx)(d,{className:`w-20`}):U.name})}),(0,z.jsxs)(`div`,{className:`flex w-full`,children:[!F&&(0,z.jsx)(`span`,{className:`truncate text-gray-700 after:mx-1 after:font-normal after:text-gray-700 after:content-["·"]`,children:le(U)}),(0,z.jsx)(`span`,{className:`text-gray-700`,children:F?(0,z.jsx)(d,{className:`w-[120px]`}):v(V,!V.authored)})]})]})]})}),!V.authored&&!F&&(0,z.jsx)(b,{following:U.followedByMe??!1,handle:le(U)})]}),(0,z.jsx)(`div`,{className:`col-[3/4] flex items-center justify-end gap-2`,children:(0,z.jsx)(be,{backgroundColor:n,currentFontSizeIndex:r,fontStyle:i,onColorChange:o,onDecreaseFontSize:l,onFontStyleChange:s,onIncreaseFontSize:c,onOpenChange:g,onResetFontSize:u})})]})}),(0,z.jsxs)(`div`,{className:`relative flex-1`,children:[(0,z.jsx)(xe,{iframeElement:X,modalRef:f,tocItems:Y,onOpenChange:y}),!F&&(0,z.jsx)(`div`,{className:`grow overflow-y-auto`,children:(0,z.jsxs)(`div`,{className:`mx-auto px-6 pt-5 pb-10`,style:{maxWidth:`904px`},children:[(0,z.jsxs)(`div`,{className:`flex flex-col items-center pb-8`,id:`object-content`,children:[De&&Ee?(0,z.jsx)(w,{className:`w-full`,label:Ee,onReveal:Me}):(0,z.jsxs)(z.Fragment,{children:[Oe&&(0,z.jsx)(ue,{className:`w-full`,onReveal:Ae}),ke&&(0,z.jsx)(`div`,{className:`mb-3 flex w-full justify-end`,children:(0,z.jsx)(h,{layout:`inline`,onHide:je})}),(0,z.jsx)(`div`,{className:`w-full`,children:(0,z.jsx)(dt,{authors:Se,backgroundColor:n,excerpt:V.summary??``,fontSize:a,fontStyle:i,heading:V.name,hideMedia:Oe,html:W,image:we,isPopoverOpen:m||_,postUrl:V?.url||``,onHeadingsExtracted:We,onIframeLoad:Ge,onLoadingChange:ze})})]}),(0,z.jsx)(`div`,{className:`-ml-3 w-full`,style:{maxWidth:K},children:(0,z.jsx)(E,{actor:U,commentCount:Ce,layout:`modal`,likeCount:V.likeCount??0,object:V,repostCount:V.repostCount??0,onLikeClick:Fe})})]}),V.type===`Tombstone`&&(0,z.jsx)(_e,{last:!0}),(0,z.jsxs)(`div`,{className:`mx-auto w-full border-t border-black/[8%] dark:border-gray-950`,style:{maxWidth:K},children:[(0,z.jsx)(he,{object:V}),(0,z.jsx)(ft,{})]}),F&&(0,z.jsx)(de,{size:`lg`}),(0,z.jsxs)(`div`,{ref:Ie,className:`mx-auto w-full`,style:{maxWidth:K},children:[ce.map((t,n)=>{let r=n===ce.length-1,i=t.mainReply.id,a=D.has(i),o=O.has(i),s=ie.has(i),c=t.chain.length>0;return(0,z.jsxs)(R.Fragment,{children:[(0,z.jsx)(P,{actor:t.mainReply.actor,allowDelete:t.mainReply.object.authored,commentCount:t.mainReply.object.replyCount??0,isChainParent:c,isPending:N(t.mainReply.id),last:!c,layout:`reply`,likeCount:t.mainReply.object.likeCount??0,object:t.mainReply.object,parentId:V.id,repostCount:t.mainReply.object.repostCount??0,type:`Note`,onClick:()=>{let n=f.current;n&&e&&$.set(e,n.scrollTop),Z(`/notes/${encodeURIComponent(t.mainReply.id)}`)},onDelete:G}),c&&t.chain[0]&&(0,z.jsx)(P,{actor:t.chain[0].actor,allowDelete:t.chain[0].object.authored,commentCount:t.chain[0].object.replyCount??0,isChainContinuation:!0,isPending:N(t.chain[0].id),last:t.chain.length===1,layout:`reply`,likeCount:t.chain[0].object.likeCount??0,object:t.chain[0].object,parentId:V.id,repostCount:t.chain[0].object.repostCount??0,type:`Note`,onClick:()=>{let n=f.current;n&&e&&$.set(e,n.scrollTop),Z(`/notes/${encodeURIComponent(t.chain[0].id)}`)},onDelete:G},t.chain[0].id),c&&a&&t.chain.slice(1).map((r,i)=>{let a=i===t.chain.slice(1).length-1,o=L&&L(n),s=a&&o;return(0,z.jsx)(P,{actor:r.actor,allowDelete:r.object.authored,commentCount:r.object.replyCount??0,isChainContinuation:!0,isPending:N(r.id),last:a&&!s,layout:`reply`,likeCount:r.object.likeCount??0,object:r.object,parentId:V.id,repostCount:r.object.repostCount??0,type:`Note`,onClick:()=>{let t=f.current;t&&e&&$.set(e,t.scrollTop),Z(`/notes/${encodeURIComponent(r.id)}`)},onDelete:G},r.id)}),c&&t.chain.length>1&&!a&&(0,z.jsx)(ge,{variant:`expand`,onClick:()=>Ne(i)}),c&&a&&o&&L&&L(n)&&(0,z.jsx)(ge,{loading:s,variant:`loadMore`,onClick:()=>Pe(i,n)}),!r&&(0,z.jsx)(ft,{})]},t.mainReply.id)}),k&&(0,z.jsx)(`div`,{className:`flex flex-col items-center justify-center text-center`,children:(0,z.jsx)(de,{size:`md`})})]}),I&&(0,z.jsx)(`div`,{ref:j,className:`h-1`})]})})]})]}),!F&&(0,z.jsxs)(`div`,{className:`pointer-events-none visible! sticky bottom-0 hidden items-end justify-between px-10 pb-[42px] lg:flex!`,children:[(0,z.jsx)(`div`,{className:`pointer-events-auto text-gray-600`,children:x(V.content??``)}),(0,z.jsxs)(`div`,{className:`pointer-events-auto min-w-10 text-right text-gray-600 transition-all duration-200 ease-out`,children:[Le,`%`]},Le)]})]})})}):(0,z.jsx)(`div`,{className:`max-h-full overflow-auto rounded-md ${n===`DARK`&&`dark`} ${(n===`LIGHT`||n===`SEPIA`)&&`light`} ${H[n].background}`,children:(0,z.jsx)(`div`,{className:`flex h-full flex-col`,children:(0,z.jsx)(`div`,{className:`relative flex-1`,children:(0,z.jsx)(`div`,{className:`sticky top-0 z-50 flex h-[102px] items-center justify-center rounded-t-md border-b max-md:h-[68px] ${H[n].background} ${H[n].border}`,children:(0,z.jsxs)(`div`,{className:`grid w-full px-8 max-lg:px-4`,style:{gridTemplateColumns:`1fr minmax(0,${K}) 1fr`},children:[(0,z.jsx)(`div`,{className:`flex items-center`,children:(0,z.jsx)(S,{className:H[n].button,onClick:t})}),(0,z.jsx)(`div`,{className:`col-[2/3] mx-auto flex w-full items-center gap-3 max-md:hidden`,children:(0,z.jsx)(`div`,{className:`grow text-center`,children:(0,z.jsx)(`span`,{children:`Error loading article.`})})})]})})})})})},ht=({isLoading:e,activities:t,currentTopic:n,fetchNextPage:r,hasNextPage:o,isFetchingNextPage:s,onTopicChange:c})=>{let d=p(),{canGoBack:m,goBack:h}=a(),[g,v]=(0,R.useState)(!1),y=i(),{topicsQuery:ee}=ae(),{data:b}=ee,x=b&&b.topics.length>0;(0,R.useEffect)(()=>{v(!!y.postId)},[y.postId]);let S=(0,R.useRef)(null),C=(0,R.useRef)(null),w=(0,R.useRef)(null);(0,R.useEffect)(()=>(S.current&&S.current.disconnect(),S.current=new IntersectionObserver(e=>{e[0].isIntersecting&&o&&!s&&r()}),C.current&&S.current.observe(C.current),w.current&&S.current.observe(w.current),()=>{S.current&&S.current.disconnect()}),[o,s,r]);let T=Math.max(0,Math.floor(t.length*.75)-1);return(0,z.jsxs)(pe,{children:[x&&(0,z.jsx)(L,{currentTopic:n,excludeTopics:[`top`],onTopicChange:c}),(0,z.jsx)(`div`,{className:`flex w-full flex-col`,children:(0,z.jsx)(`div`,{className:`w-full`,children:t.length>0?(0,z.jsx)(`div`,{className:`my-4`,children:(0,z.jsx)(`div`,{className:`mx-auto flex min-h-[calc(100dvh_-_117px)] items-start gap-11`,children:(0,z.jsx)(`div`,{className:`flex w-full min-w-0 flex-col items-center`,children:(0,z.jsxs)(`div`,{className:`flex w-full min-w-0 flex-col items-start`,children:[(0,z.jsxs)(`ul`,{className:`mx-auto flex w-full flex-col`,"data-testid":`inbox-list`,children:[t.map((n,r)=>(0,z.jsxs)(`li`,{"data-testid":`inbox-item`,"data-test-view-article":!0,children:[(0,z.jsx)(P,{actor:n.actor,allowDelete:n.object.authored,commentCount:n.object.replyCount??0,isLoading:e,isPending:N(n.id),layout:`inbox`,likeCount:n.object.likeCount??0,object:n.object,repostCount:n.object.repostCount??0,type:n.type,onClick:()=>{d(`/reader/${encodeURIComponent(n.id)}`)}}),r<t.length-1&&(0,z.jsx)(fe,{}),r===T&&(0,z.jsx)(`div`,{ref:C,className:`h-1`})]},`${n.id}-${n.type}-${r}`)),s&&(0,z.jsx)(`li`,{className:`flex flex-col items-center justify-center gap-4 text-center`,children:(0,z.jsx)(de,{size:`md`})})]}),(0,z.jsx)(`div`,{ref:w,className:`h-1`})]})})})}):n===`following`?(0,z.jsx)(`div`,{className:`mt-[24vh]`,children:(0,z.jsx)(f,{actions:x?(0,z.jsx)(u,{onClick:()=>d(`/explore`),children:`Find accounts to follow →`}):(0,z.jsx)(u,{asChild:!0,children:(0,z.jsx)(`a`,{href:`https://explore.ghost.org/social-web`,rel:`noopener noreferrer`,target:`_blank`,children:`Find accounts to follow →`})}),description:`Start following publishers to see their long-form posts here.`,title:`Your Reader is empty`,children:(0,z.jsx)(l,{})})}):(0,z.jsx)(`div`,{className:`mt-[24vh]`,children:(0,z.jsx)(f,{description:`Explore other topics for more content.`,title:`Nothing here yet`,children:(0,z.jsx)(l,{})})})})}),(0,z.jsx)(ie,{open:g,onOpenChange:e=>{e||(m?h():d(`/reader`)),v(e)},children:(0,z.jsxs)(I,{className:`inset-y-3 h-[calc(100vh-24px)] w-screen max-w-[calc(100vw-24px)] animate-none! p-0 focus:outline-hidden dark:bg-gray-950`,children:[(0,z.jsxs)(D,{className:`hidden`,children:[(0,z.jsx)(_,{children:`Reader`}),(0,z.jsx)(k,{children:`Ghost reader for long form articles`})]}),y.postId&&(0,z.jsx)(mt,{postId:y.postId,onClose:()=>{m?h():d(`/reader`)}})]})})]})},gt=()=>{let[e,t]=(0,R.useState)(`following`),{inboxQuery:n}=A({enabled:e===`following`}),{discoveryFeedQuery:r}=se({enabled:e!==`following`,topic:e}),{data:i,error:a,fetchNextPage:o,hasNextPage:s,isFetchingNextPage:c,isLoading:l}=e===`following`?n:r,u=a&&m(a)&&a.statusCode===404&&e!==`following`;return a&&m(a)&&!u?(0,z.jsx)(ce,{errorCode:a.code,statusCode:a.statusCode}):(0,z.jsx)(ht,{activities:u?[]:i?.pages.flatMap(e=>e.posts)??Array.from({length:5},(e,t)=>({id:`placeholder-${t}`,object:{}})),currentTopic:e,fetchNextPage:o,hasNextPage:s,isFetchingNextPage:c,isLoading:l,onTopicChange:t})};export{gt as default};